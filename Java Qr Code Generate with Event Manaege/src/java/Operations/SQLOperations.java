...
public class SQLOperations extends RegisterModelHandle{
    ...
    /*public static void main(String [] args){
        ...
        //System.out.println(ops.GetAndStorePass("Vimal", "1234"));
        /*System.out.println(ops.getUserName());
        System.out.println(ops.getPassWord());
        ops.imageUpload("Vimal", "assets/QrImage/JD.png");
    }*/
}
